            ...
            <div class="modal-edit__wrapper">
                <div class="modal-edit__container animate animate__zoomIn" id="modal-edit-container">
                    <div class="modal-edit__content">
                        <button class="btn-default modal-edit__btn-close" id="modal-order-close-btn" type="button">
                            <img src="assets/icons/x-mark.svg" alt="x-mark">
                        </button>
                        <h2 class="modal-edit__title">Book Information</h2>
                        <h3 class="modal-edit__book-title">${bookInfo.name}</h3>
                        <h4 class="modal-edit__author">${bookInfo.author}</h4>
         
                        <div class="modal-edit__buttons">
                            <button class="btn-default modal-edit__btn-edit" id="modal-edit-btn-edit" type="button">
                                Edit
                            </button>
                            
                            <button class="modal-edit__btn-square" id="btn-favorite" type="button">
                                <svg width="20" height="18" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path 
                                        id="modal-edit-btn-favorite-icon"
                            ...
                            <button class="modal-edit__btn-square" id="btn-trash" type="button">
