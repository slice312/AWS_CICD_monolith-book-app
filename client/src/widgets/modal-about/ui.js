                        ...
                        <div class="modal-about__buttons">
                            ...
                            <button class="modal-about__btn-square" id="btn-favorite" type="button">
                                <svg width="20" height="18" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path id="modal-about-btn-favorite-icon" d="M19.3762 2.5401C18.5386 0.825205 16.1258 -0.577889 13.3191 
                            ...
                            <button class="modal-about__btn-square" id="btn-trash" type="button">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M19.1667 3.6H15.8333V1.6C15.8333 0.7175 15.0859 0 14.1667 0H5.83333C4.91406 0 4.16667 0.7175
